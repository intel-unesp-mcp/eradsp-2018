...
int main (int argc, char *argv[]) {
	...
	int tamanho = atoi(argv[1]);
        ...
        //Alocando dinamicamente as matrizes A (entrada) e B (saída) utilizando hbw_malloc
        a = (double*)hbw_malloc(tamanho*tamanho*sizeof(double));
        b = (double*)hbw_malloc(tamanho*tamanho*sizeof(double));
